...
├── HOST ENVIRONMENT (Development Tools)
...
|-------------|-----------------|-------------------|
| **Host Environment** | Development & deployment tools | [`docs/host/README.md`](docs/host/README.md) |
...
**Important**: After completing the Pi-hole installation and verifying all services are running properly, you must configure your router to use the Pi-hole as your network's DNS server for network-wide ad blocking to take effect.
